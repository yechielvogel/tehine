...
class DateUtils {
  ...
  //   // Calculate the last day to display, considering the next seven days only
  //   var lastToDisplay =
  //       firstToDisplay.add(Duration(days: 6 < daysAfter ? 6 : daysAfter));

  //   // Include today in the list of days if it's within the next seven days
  //   if (today.isAfter(firstToDisplay) &&
  //       today.isBefore(lastToDisplay.add(Duration(days: 1)))) {
  //     firstToDisplay = today;
  //   }

  //   return daysRange(firstToDisplay, lastToDisplay)
  //       .map((date) => date.add(Duration(days: 1))) // Adjust indexing
  //       .toList();
  // }
  ...
  //   // Include today in the list of days
  //   if (today.isAfter(firstToDisplay) && today.isBefore(last.add(Duration(days: 1)))) {
  //     firstToDisplay = today;
  //   }

  //   return daysRange(firstToDisplay, last.add(Duration(days: daysAfter))).toList();
  // }
...
//    static DateTime firstDayOfToDisplay(DateTime month) {
//     return DateTime(month.year, month.month);
//   }
